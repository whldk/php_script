...
class Model
{
	 ...
	 * 注意数量问题
	 */
	public static function _select($pack, $fields, $num = null, $order = null)
	{
	 ...
	 public static function _batch_insert($inserts, $fields, $chunkSize = 100)
	{
	 ...
	 public static function _insert($fields, $dku = null)
	{
	 ...
	 public static function _update($where, $vals, $limit = null)
	{
		if (!$where || !$vals) {
			return 0;
		}
